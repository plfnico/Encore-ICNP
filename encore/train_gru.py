...
def get_trainset(data, block_size, n_size, n_interval, max_len, min_samples, device):
    ...
    for seq in data:
        ...
        size_seq = np.clip(size_seq, 0, n_size - 1)
...
if __name__ == "__main__":
    ...
    print('encoder parameters: {}'.format(get_model_params(model.gru)[0]))
    print('encoder parameters: {}'.format(get_model_params(model.s2h)[0]))
    exit(0)
